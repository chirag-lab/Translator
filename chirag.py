...
#for icon
image_icon=PhotoImage(file="dd.png")
root.iconphoto(False, image_icon)

#for arrow
arrow_image=PhotoImage(file="arrrow.png")
...
f1.place(x=640,y=118,width=440,height=210)
...
#translate buton 
translate=Button(root,text="convert",font="Roboto 15 bold italic",
                activebackground="purple" , cursor="hand2" , bd=5, 
                 bg= 'black', fg="white" ,command =translate_now)
